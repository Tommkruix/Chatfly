...
function AdministrationUserPostActionsScreen({ navigation, route }) {
  const placeholderUserImage = "https://yourcampushub.online/chatfly/a.png";

  const uid = route.params.ref_uid;
          ...
          renderItem={({ item }) => (
            <View>
              ...
              <FeedComponent
                ...
                onDeletePress={() => {
                  DeletePost(item.userid, item.postid);
                }}
                deletePost={true}
              />
            </View>
...
export default AdministrationUserPostActionsScreen;
