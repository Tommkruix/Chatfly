...
function CoinWithdrawRequestsScreen({ navigation }) {
    ...
    firebase
      ...
      .once("value", (snapshot) => {
        if (
          ...
          defaultAmt = snapshot.child("converted_coins").val();
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader
        ...
        headerName="Converted Coin Withdraws"
      />
      <FlatList
        style={{ marginTop: 10 }}
        ...
        renderItem={({ item }) => (
          <ConversationItem
            ...
            //bio={"item.bio"}
            description={`wants to withdraw ${item.amount} coins`}
...
export default CoinWithdrawRequestsScreen;
